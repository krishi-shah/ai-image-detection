...
| Property | Detail |
|---|---|
| Total images | 120,000 on disk (100K train + 20K test; paper/Kaggle often cite 60K) |
| Real images | 60,000 (CIFAR-10 sourced; 50K train + 10K test) |
| AI-generated images | 60,000 (Stable Diffusion v1.4; 50K train + 10K test) |
...
**Grad-CAM** (Selvaraju et al., 2017) is integrated using the `pytorch-grad-cam` library. The target layer is the final convolutional head of EfficientNet-B3 (`model.conv_head`), which provides the highest-level spatial features before the classifier.
